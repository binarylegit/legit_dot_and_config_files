...
if version < 600
    ...
    " Normal oneliners
     ...
     " distinction)
     syntax keyword gemfileBlockKeywords source path bundle_path group
     " platforms git env
     highlight link gemfileBlockKeywords Keyword

     " Old Gemfile Syntax
     syntax keyword gemfileDeprecated only except disable_rubygems
     " disable_system_gems clear_sources bundle_path bin_path
